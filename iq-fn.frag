...
float sca = 0.5 + 0.15*sin((iGlobalTime * 0.1) -10.0);
vec4 grow = vec4(1.0);
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    grow = smoothstep( 0.0, 1.0, ((iGlobalTime * 0.1) -vec4(0.0,1.0,2.0,3.0))/3.0 );
    ...
    float an = 1.1 + 0.05*((iGlobalTime * 0.1) -10.0) - 7.0*m.x;
